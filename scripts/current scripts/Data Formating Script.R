...
d <- read.csv("CP Github/data/cpdataposter.csv")
...
vars = c('dot', 'condition','cp_number','cp_sex', 'cp_race', 'cp_ethnicity', 'Qpractice1','Qpractice1.5',
...
d2 <- d %>% 
  mutate(exclude= case_when(Qctrl1=="yes"~1,
                            ...
                            cp_number == "Test_4.7.4" ~1,
                            cp_number == "CP_4.8.4" ~1,
                            cp_number == "TEST" ~1,
                            cp_age == "7" ~1,
                            TRUE~0))
...
d_1<-d3 %>% 
  filter(condition=="1") %>% 
  select(dot, condition, cp_number, cp_age, cp_sex, cp_race, cp_ethnicity, Qctrl1,	
...
#1
long1 <- d_1 %>% 
  gather(injury, rating, -c(dot, condition, cp_number, cp_age, cp_sex,cp_race, cp_ethnicity,
                            Qctrl1, Qctrl1.5, Qctrl2,	Qctrl2.5,	Qctrl3,	Qctrl3.5,	Qctrl4,	Qctrl4.5,
                            Q1, Q1.5,	Q2,	Q2.5,	Q3,	Q3.5, Q4,	Q4.5,	Q5,	Q5.5,	Q6,	Q6.5,	Q7,	Q7.5,	Q8,	Q8.5))
...
# NEEDS TO BE UPDATED: save the participant log as csv, pull columns "participant ID" and "birthday",  then append bday to cp by participant id
# - Brooke can do this or teach someone else how to do this!!
